...
int check_for_dependencies(int val_to_check, int length, int m_dependencies_final_2nd_indices[length]) {
  ...
  for (int count = 0; count < length; count++) {
    ...
    printf("val_to_check: %i \n", val_to_check);
    printf("Place: %i \n", place);
    // printf("m_dependencies_final_2nd_indices 0 : %i \n", m_dependencies_final_2nd_indices[0]);
    // printf("m_dependencies_final_2nd_indices 1 : %i \n", m_dependencies_final_2nd_indices[1]);
    printf("Value in Place: %i \n", m_dependencies_final_2nd_indices[place]);
  }
